...
func (w Wrapper) Debug(msg string, args ...interface{}) {
	w.Zap.With(w.lazyFields...).Debug(msg, convertToZapAny(args...)...)
}
func (w Wrapper) Info(msg string, args ...interface{}) {
	w.Zap.With(w.lazyFields...).Info(msg, convertToZapAny(args...)...)
}
func (w Wrapper) Warn(msg string, args ...interface{}) {
	w.Zap.With(w.lazyFields...).Warn(msg, convertToZapAny(args...)...)
}
func (w Wrapper) Error(msg string, args ...interface{}) {
	w.Zap.With(w.lazyFields...).Error(msg, convertToZapAny(args...)...)
}
